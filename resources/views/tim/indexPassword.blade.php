...
<div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Kelola Password Tim</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('tim.ubahPassword', $id) }}" method="GET" enctype="multipart/form-data">
                                @csrf
                                <div class="form-row">
                                ...
                                <a href="{{ route('projek.indexbyidTim', $id) }}" class="btn btn-sm btn-warning" style="font-size : 18px;">CANCEL</a>
                            </form>
                        </div>
                        <!-- /.card-body -->
                    </div>

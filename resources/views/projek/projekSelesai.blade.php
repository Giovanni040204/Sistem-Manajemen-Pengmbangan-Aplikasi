...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Projek Selesai</h1>
                </div>
                <!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">  
                <div class="col-sm-12">
                    <ol class="float-sm-right">
                        <form action="{{ route('projek.projekSelesai') }}" class="form-inline" method="GET">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{ route('projek.destroySelesai', $item->id) }}" method="POST" class="d-inline">
                                                                @csrf
                                                                @method('DELETE')

            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="float-sm-right">
                        <form action="{{ route('projek.historySupervisor', $id) }}" class="form-inline" method="GET">
                                        ...
                                        <tr>
                                            ...
                                            @if($item->status == 'Selesai')
                                                <td class="text-center">
                                                    <a href="{{ route('evaluasi.indexSupervisor', [$id, $item->id]) }}" class="btn btn-sm btn-primary">EVALUASI</a>
                                                </td>
                                            @else

                        ...
                        <form>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control @error('deksripsi') is-invalid @enderror" name="deskripsi" value="{{ $evaluasi->parentProjek->deskripsi }}" disabled>
                                </div>
                                <div class="form-group col-md-12">
                                    <label class="font-weight-bold">Isi Evaluasi</label>
                                    <textarea class="form-control @error('isi') is-invalid @enderror" name="isi" placeholder="Masukkan Evaluasi..." rows="10" disabled>{{ $evaluasi->isi }}</textarea>
                                    @error('isi')
